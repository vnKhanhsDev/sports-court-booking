...
import type { PlayerBookingResponse, BookingStatus } from "@/features/booking/types/booking.types";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <Link to={ROUTES.PUBLIC.MARKETPLACE.SEARCH} className={styles.newBookingButton}>
          <span>+</span>
      ...
      {isLoading ? (
        ...
        <div className={styles.empty}>
          ...
          {!searchQuery && filterStatus === "all" && (
            <Link to={ROUTES.PUBLIC.MARKETPLACE.SEARCH} className={styles.emptyButton}>
              Tìm sân ngay
            </Link>
          )}
        </div>
          ...
          {filteredBookings.map((booking) => (
            <div key={booking.id} className={styles.bookingCard}>
              ...
              <div className={styles.bookingActions}>
                <Link
                  to={ROUTES.PUBLIC.MARKETPLACE.DETAIL.replace(":id", booking.courtId.toString())}
