...
import styles from "./BookingManagementTimeline.module.css";

interface BookingManagementTimelineProps {
...
export default function BookingManagementTimeline({
    bookings,
    courts,
    onBookingClick,
    onEmptySlotClick
}: BookingManagementTimelineProps) {
                        ...
                        return (
                            <div key={court.id} className={styles.courtRow}>
                                ...
                                <div className={styles.timelineGrid}>
                                    ...
                                    {/* Booking Blocks - positioned within grid */}
