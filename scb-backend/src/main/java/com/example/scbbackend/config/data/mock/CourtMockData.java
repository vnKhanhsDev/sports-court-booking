    ...
    public void mock(List<Facility> facilities, List<PriceList> priceLists) {
        ...
        for (CourtData cd : COURT_DATA) {
            Court court = Court.builder()
                    ...
                    .courtType(catalogService.getCourtTypeBySportCodeAndCode(cd.sportCode(), cd.courtTypeCode()))
                    .surfaceType(catalogService.getSurfaceTypeBySportCodeAndCode(cd.sportCode(), cd.surfaceTypeCode()))
                    .name(cd.courtName())
